...
class UtilParser {
    ...
    static Spsostlic getSostlic(GPathResult gPathResult, List list) {
    ...
    static Splicorg getLicorg(GPathResult gPathResult, List list) {
    ...
    static Spregorg getRegorg(GPathResult gPathResult, List list) {
